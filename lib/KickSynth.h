...
class KickSynth : public Synth {
 ...
 public:
  KickSynth(double sr = 44100.0, double base_frequency = 40.0,
            double ratio = 8.0, double sweep_time = 0.1, double preamp = 2.0,
            double amp = 0.5, double decay1 = 0.4, double decay1_length = 0.05,
            double decay2 = 0.15, double decay2_length = 0.1,
